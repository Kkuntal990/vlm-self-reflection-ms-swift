#!/usr/bin/env bash
#
# Feedback SFT Training Script for Qwen2.5-VL-7B on FIRE Dataset
#
...
# ============================================
RUN_NAME="${RUN_NAME:-qwen2_5vl-7b-instruct-fire-feedback-sft}"
...
# ============================================
echo "========================================="
echo "FIRE Feedback SFT Training"
